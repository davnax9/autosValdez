...
import CarImagesModal from "./CarImagesModal"
  ...
  return (
    <>
      <div className="border shadow-lg rounded-lg">
          <div className="overflow-hidden cursor-pointer" onClick={() => setIsOpen(true)}>
            {imagePath && (
      ...
      <CarImagesModal car={car} isOpen={isOpen} onClose={() => setIsOpen(false)}/>
    </>
